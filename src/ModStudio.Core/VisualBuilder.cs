...
{
    public static bool Supports(string? table) => table is "uniqueitems" or "setitems" or "missiles" or "monstats" or "weapons" or "armor" or "misc" or "cubemain" or "runes" or "levels";
